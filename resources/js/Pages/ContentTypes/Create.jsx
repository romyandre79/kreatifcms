...
export default function Create({ allContentTypes }) {
    ...
    return (
        <AuthenticatedLayout
            header={<h2 className="text-xl font-semibold leading-tight text-gray-800">Create Content Type</h2>}
        >
                    ...
                    <form onSubmit={handleSubmit} className="space-y-6">
                        ...
                        <div className="bg-white p-6 shadow sm:rounded-lg">
                            <div className="flex justify-between items-center mb-6">
                                <h3 className="text-lg font-medium text-gray-900 font-premium">Fields Configuration</h3>
                                <button
                                    type="button"
                                    onClick={addField}
